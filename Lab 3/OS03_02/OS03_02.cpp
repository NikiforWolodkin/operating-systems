...
int main()
{
	...
	LPCWSTR OS03_02_1 = LR"(..\x64\Debug\OS03_02_1.exe)";
	LPCWSTR OS03_02_2 = LR"(..\x64\Debug\OS03_02_2.exe)";
	...
	else
	{
		...
		wcout << L"[ERROR] Process OS03_02_1 was not created. Error: " << sErrMsg << endl;
